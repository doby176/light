# ThinkOrSwim NASDAQ Previous High/Low Analysis - Simple Working Version
...
# Plot historical medians (simplified)
...
def high_continuation_comparison = 
    ...
    "Historical Median: " + Round(high_continuation_10min_median, 2) + "%\n" +
    "Strength: " + Round((continuation_move_10min_high - high_continuation_10min_median) / AbsValue(high_continuation_10min_median), 2);

def high_reversal_comparison = 
    "High Reversal:\n" +
    "Current: " + Round(reversal_move_10min_high, 2) + "%\n" +
    "Historical Median: " + Round(high_reversal_10min_median, 2) + "%\n" +
    "Strength: " + Round((reversal_move_10min_high - high_reversal_10min_median) / AbsValue(high_reversal_10min_median), 2);

def low_continuation_comparison = 
    "Low Continuation:\n" +
    "Current: " + Round(continuation_move_10min_low, 2) + "%\n" +
    "Historical Median: " + Round(low_continuation_10min_median, 2) + "%\n" +
    "Strength: " + Round((continuation_move_10min_low - low_continuation_10min_median) / AbsValue(low_continuation_10min_median), 2);

def low_reversal_comparison = 
    "Low Reversal:\n" +
    "Current: " + Round(reversal_move_10min_low, 2) + "%\n" +
    "Historical Median: " + Round(low_reversal_10min_median, 2) + "%\n" +
    "Strength: " + Round((reversal_move_10min_low - low_reversal_10min_median) / AbsValue(low_reversal_10min_median), 2);
