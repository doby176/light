...
# Strategy: Enter on 1st green dot only, exit when price closes below green dot level
...
# --- Strategy Logic ---
# Enter on 1st green dot only
def shouldEnterLong = currentPosition[1] == 0 and isBullishOrderBlock and bullishUnmitigated and greenDotCount == 1;
...
# --- Strategy Orders ---
# Enter on 1st green dot only
AddOrder(OrderType.BUY_TO_OPEN, shouldEnterLong, close1, 100, Color.GREEN, Color.GREEN, "1ST Green Dot - Enter Long");

# Exit when price closes below green dot level
AddOrder(OrderType.SELL_TO_CLOSE, shouldExitLong, close1, 100, Color.RED, Color.RED, "Exit Long");

# --- Performance Labels ---
AddLabel(yes, "1ST Green Dot Strategy", Color.WHITE);
...
# --- Alerts ---
Alert(shouldEnterLong, "1ST Green Dot - Enter LONG", Alert.BAR, Sound.Bell);
