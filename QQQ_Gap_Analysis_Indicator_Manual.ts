...
# CORRECTED: Using max_move_gap_direction_first_30min_pct from FILLED gaps only - calculated from OPEN price
def moveBeforeFillMedian = 
    if gapSizeBin == 1 then # Bin 1 (0.15-0.35%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.20 else 0.17
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.12 else 0.18
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.16 else 0.18
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.15 else 0.17
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.11 else 0.22
        else 0.20
    else if gapSizeBin == 2 then # Bin 2 (0.35-0.5%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.20 else 0.28
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.20 else 0.19
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.22 else 0.13
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.14 else 0.26
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.17 else 0.23
        else 0.25
    else if gapSizeBin == 3 then # Bin 3 (0.5-1%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.25 else 0.25
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.21 else 0.15
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.19 else 0.18
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.16 else 0.28
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.23 else 0.12
        else 0.30
    else if gapSizeBin == 4 then # Bin 4 (1-1.5%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.43 else 0.88
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.33 else 0.37
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.09 else 0.27
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.26 else 0.81
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.11 else 0.31
        else 0.40
    else if gapSizeBin == 5 then # Bin 5 (1.5%+)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.23 else 0.96
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.25 else 0.35
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.57 else 0.20
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.10 else 0.26
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.48 else 0.36
        else 0.50
    else 0.25; # Default
...
def moveBeforeFillAverage = 
    if gapSizeBin == 1 then # Bin 1 (0.15-0.35%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.23 else 0.23
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.19 else 0.22
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.18 else 0.25
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.20 else 0.23
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.17 else 0.25
        else 0.20
    else if gapSizeBin == 2 then # Bin 2 (0.35-0.5%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.28 else 0.33
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.25 else 0.24
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.27 else 0.20
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.22 else 0.28
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.17 else 0.23
        else 0.25
    else if gapSizeBin == 3 then # Bin 3 (0.5-1%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.27 else 0.32
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.22 else 0.29
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.28 else 0.30
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.22 else 0.36
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.26 else 0.33
        else 0.30
    else if gapSizeBin == 4 then # Bin 4 (1-1.5%)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.41 else 0.57
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.39 else 0.29
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.06 else 0.31
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.27 else 0.79
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.18 else 0.34
        else 0.40
    else if gapSizeBin == 5 then # Bin 5 (1.5%+)
        if dayOfWeek == 0 then # Monday
            if gapDirection == 1 then 0.18 else 2.60
        else if dayOfWeek == 1 then # Tuesday
            if gapDirection == 1 then 0.29 else 0.81
        else if dayOfWeek == 2 then # Wednesday
            if gapDirection == 1 then 0.37 else 0.40
        else if dayOfWeek == 3 then # Thursday
            if gapDirection == 1 then 0.08 else 0.33
        else if dayOfWeek == 4 then # Friday
            if gapDirection == 1 then 0.35 else 0.25
        else 0.50
    else 0.25; # Default
