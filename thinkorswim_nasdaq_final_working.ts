...
# Simple historical median selection (no complex conditionals)
def current_high_continuation_median = high_continuation_10min_median;
def current_high_reversal_median = high_reversal_10min_median;
def current_low_continuation_median = low_continuation_10min_median;
def current_low_reversal_median = low_reversal_10min_median;
