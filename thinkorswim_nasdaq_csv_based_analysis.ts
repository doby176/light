...
# Get appropriate statistics based on current conditions
def get_current_high_continuation_median() {
...
def get_current_high_reversal_median() {
    if open_position == 0 then {
...
def get_current_low_continuation_median() {
    if open_position == 0 then {
...
def get_current_low_reversal_median() {
    if open_position == 0 then {
...
plot(get_current_high_continuation_median(), "High Continuation Median", Color.ORANGE, 1);
plot(get_current_high_reversal_median(), "High Reversal Median", Color.PINK, 1);
plot(get_current_low_continuation_median(), "Low Continuation Median", Color.CYAN, 1);
plot(get_current_low_reversal_median(), "Low Reversal Median", Color.MAGENTA, 1);
...
def high_continuation_comparison = 
    ...
    "Historical Median: " + Round(get_current_high_continuation_median(), 2) + "%\n" +
    "Strength: " + Round((continuation_move_10min_high - get_current_high_continuation_median()) / AbsValue(get_current_high_continuation_median()), 2);

def high_reversal_comparison = 
    "High Reversal:\n" +
    "Current: " + Round(reversal_move_10min_high, 2) + "%\n" +
    "Historical Median: " + Round(get_current_high_reversal_median(), 2) + "%\n" +
    "Strength: " + Round((reversal_move_10min_high - get_current_high_reversal_median()) / AbsValue(get_current_high_reversal_median()), 2);

def low_continuation_comparison = 
    "Low Continuation:\n" +
    "Current: " + Round(continuation_move_10min_low, 2) + "%\n" +
    "Historical Median: " + Round(get_current_low_continuation_median(), 2) + "%\n" +
    "Strength: " + Round((continuation_move_10min_low - get_current_low_continuation_median()) / AbsValue(get_current_low_continuation_median()), 2);

def low_reversal_comparison = 
    "Low Reversal:\n" +
    "Current: " + Round(reversal_move_10min_low, 2) + "%\n" +
    "Historical Median: " + Round(get_current_low_reversal_median(), 2) + "%\n" +
    "Strength: " + Round((reversal_move_10min_low - get_current_low_reversal_median()) / AbsValue(get_current_low_reversal_median()), 2);
